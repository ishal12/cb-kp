...
@section('title', 'BUAT - KALENDER ABSENSI')
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Form Buat Kalender Absensi</h3>
            </div><!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="POST" action="{{ route('absnKalender.store') }}">
